class Kubegonfig < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/al-bashkir/kubegonfig/releases/download/v#{version}/kubegonfig-darwin-arm64"
      sha256 "71eb22fc759d1deb047850c94960ef8af049010f07a7d509382e0a6d5f1cd8e8"
    end
    on_intel do
      url "https://github.com/al-bashkir/kubegonfig/releases/download/v#{version}/kubegonfig-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/al-bashkir/kubegonfig/releases/download/v#{version}/kubegonfig-linux-arm64"
      sha256 "e837328bc20f3ba862e845cd276c20a26b2ac2cf5484e921e13d59761c2352a8"
    end
    on_intel do
      url "https://github.com/al-bashkir/kubegonfig/releases/download/v#{version}/kubegonfig-linux-amd64"
