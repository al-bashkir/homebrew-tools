class SshTui < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/al-bashkir/ssh-tui/releases/download/v1.3.1/ssh-tui_v1.3.1_darwin_arm64.tar.gz"
      sha256 "1679a9a28b087a135f6a2cca350018c9cc3b191da69f4f3ad5ace2941489d4e9"
    end
    on_intel do
      url "https://github.com/al-bashkir/ssh-tui/releases/download/v1.3.1/ssh-tui_v1.3.1_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/al-bashkir/ssh-tui/releases/download/v1.3.1/ssh-tui_v1.3.1_linux_arm64.tar.gz"
      sha256 "f7ed3cbdebf272e24205060f6857e6f1a4a675bc735596dcfe1527e3976c2289"
    end
    on_intel do
      url "https://github.com/al-bashkir/ssh-tui/releases/download/v1.3.1/ssh-tui_v1.3.1_linux_amd64.tar.gz"
